...
export const Home = () => {
  ...
  const parallaxY = useTransform(scrollY, [0, 1000], [0, -500]);
    ...
    <main style={{ height: "2000px" }}>
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-opacity-50 bg-gray-900">
          <h1 className="lg:w-2/5 md:w-3/4 text-center text-4xl lg:text-6xl  text-white font-bold mb-4 italic sombra-letras">
            CAMARONES AL MOJO DE AJO
          </h1>
          <ButtonHome icon="mdi:delivery-dining" text="PIDELOS A DOMICILIO" />
        </div>
      </motion.section>
      ...
      >
        <div className="w-full md:w-1/2 p-8 flex flex-col text-center justify-center items-center order-1 md:order-1">
          <h2 className="text-md lg:text-4xl font-bold mb-4">
            Mariscos, cortes y enchiladas huastecas en La Barbada Restaurante
          </h2>
          <p className="text-[0.678rem] md:text-base mb-4">
            Donde se sirven los mariscos más frescos, los cortes de carne más
            tiernos y el bar más abastecido.
          </p>
          <p className="text-[0.678rem] md:text-base mb-4">
            ¡Vengan a hacerse piratas de la buena comida!
          </p>
          <ButtonHome
      ...
      >
        <div className="w-full md:w-1/2 p-8 flex flex-col text-center justify-center items-center order-1 md:order-2">
          ...
          <p className="text-[0.678rem] md:text-base mb-4">
            Reserva tu mesa ahora en La Barbada Restaurante y prepárate para una
            experiencia culinaria inolvidable.
          </p>
          <p className="text-[0.678rem] md:text-base mb-4">
            {" "}
            ¡No pierdas la oportunidad de convertirte en un capitán de la buena
            comida!
          </p>
          <ButtonHome icon="ion:calendar-number" text="RESERVA AHORA" />
        </div>
      ...
      >
        <div className="w-full md:w-1/3 p-4 flex flex-col items-center">
          ...
          <p className="text-center">
            Estamos ubicados en Huejutla de Reyes, Hidalgo, Carretera México -
            Pachuca KM 214, a 100 metros de la clínica ISSSTE.
          </p>
          <ButtonHome icon="simple-icons:googlemaps" text="VER MAPA" />
        </div>
        <div className="w-full md:w-1/3 p-4 flex flex-col items-center lg:border-l lg:border-r border-black">
          ...
          <p className="text-center">
            En La Barbada queremos ofrecerte la mejor experiencia, en un lugar
            cómodo, platillos exquisitos, y una atención digna de un capitán.
            Por ello, el staff de La Barbada colabora para brindarte una
        ...
        <div className="w-full md:w-1/3 p-4 flex flex-col items-center">
          ...
          <p className="text-center">
            20 años de un exquisito viaje, cuando todo comenzó como un pequeño
            botanero familiar, hoy tenemos el gusto de celebrar contigo la rica
            cocina que hemos perfeccionado a través de los años.
          </p>
      ...
      >
        <div className="w-full md:w-1/2 p-8 flex flex-col text-center justify-center items-center order-1 md:order-1">
          ...
          <p className="text-[0.678rem] md:text-base mb-4">
            Ponemos a tus ordenes un área climatizada, con capacidad de 100
            personas, terraza con un paisaje fotografico, y un salón con
            capacidad de 300 personas.
          </p>
          <p className="text-[0.678rem] md:text-base mb-4">
